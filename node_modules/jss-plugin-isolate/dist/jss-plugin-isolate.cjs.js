...
var inheritedInitials = require('css-initials/inherited');
var allInitials = require('css-initials/all');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var _extends__default = /*#__PURE__*/_interopDefaultLegacy(_extends);
var inheritedInitials__default = /*#__PURE__*/_interopDefaultLegacy(inheritedInitials);
var allInitials__default = /*#__PURE__*/_interopDefaultLegacy(allInitials);
...
var initialsMap = {
  inherited: inheritedInitials__default['default'],
  all: allInitials__default['default']
};
...
var getStyle = function getStyle(option) {
  ...
  if (typeof option === 'object') {
    ...
    if (Array.isArray(option)) {
      var type = option[0];
      var style = option[1];
      return _extends__default['default']({}, initialsMap[type], style);
    } // Option is a style object, use inherited initials by default.


    return _extends__default['default']({}, inheritedInitials__default['default'], option);
  }

  return inheritedInitials__default['default'];
};
